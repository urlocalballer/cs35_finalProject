...
def run_game():
    ...
    pi = Pipe(gameDisplay, DISPLAY_W, 300, PIPE_LOWER)  #This is all you have to do to have a single pipe
    #It's on the current display, starts at the very right of the screen 300 pixels up. Pipe_lower defines that this pipe is on the bottom
    ...
    while running:
        ...
        pi.update(dt)   #This updates the pipe on every loop
